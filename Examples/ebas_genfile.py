...
def set_fileglobal_metadata(nas):
    ...
    nas.metadata.originator.append(
        DataObject(
            PS_LAST_NAME='Aas', PS_FIRST_NAME='Wenche', PS_EMAIL='waa@nilu.no',
    ...
    nas.metadata.station_name = u'Zeppelin mountain (Ny-Ålesund)'

    nas.metadata.station_wdca_id = 'GAWANO__ZEP'
    nas.metadata.station_gaw_id = 'ZEP'
    nas.metadata.station_gaw_name = u'Zeppelin Mountain (Ny Ålesund)'
    ...
    nas.metadata.station_latitude = 78.906667
    nas.metadata.station_longitude = 11.888333
    nas.metadata.station_altitude = 474.0
